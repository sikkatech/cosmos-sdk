...
type TextProposal struct {
	...
	Tallystrategy string `protobuf:"bytes,3,opt,name=tallystrategy,proto3" json:"tallystrategy,omitempty"`
}
...
type ExecuteMsgsProposal struct {
	Title       string       `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description string       `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	Messages    []*types.Any `protobuf:"bytes,3,rep,name=messages,proto3" json:"messages,omitempty"`
}

func (m *ExecuteMsgsProposal) Reset()      { *m = ExecuteMsgsProposal{} }
func (*ExecuteMsgsProposal) ProtoMessage() {}
func (*ExecuteMsgsProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_6e82113c1a9a4b7c, []int{1}
}
func (m *ExecuteMsgsProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ExecuteMsgsProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExecuteMsgsProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ExecuteMsgsProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecuteMsgsProposal.Merge(m, src)
}
func (m *ExecuteMsgsProposal) XXX_Size() int {
	return m.Size()
}
func (m *ExecuteMsgsProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_ExecuteMsgsProposal.DiscardUnknown(m)
}

var xxx_messageInfo_ExecuteMsgsProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ExecuteMsgsProposal)(nil), "cosmos.gov.v1beta1.ExecuteMsgsProposal")
...
var fileDescriptor_6e82113c1a9a4b7c = []byte{
	...
	,
}
...
func (this *TextProposal) Equal(that interface{}) bool {
	...
	if this.Tallystrategy != that1.Tallystrategy {
		return false
	}
	return true
}
func (this *ExecuteMsgsProposal) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ExecuteMsgsProposal)
	if !ok {
		that2, ok := that.(ExecuteMsgsProposal)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *TextProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Tallystrategy) > 0 {
		i -= len(m.Tallystrategy)
		copy(dAtA[i:], m.Tallystrategy)
		i = encodeVarintGov(dAtA, i, uint64(len(m.Tallystrategy)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *ExecuteMsgsProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ExecuteMsgsProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ExecuteMsgsProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ExecuteMsgsProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TextProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Tallystrategy", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Tallystrategy = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *ExecuteMsgsProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExecuteMsgsProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExecuteMsgsProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
