...
# simd tx bank send validator cosmos1gyq9gpp5geh0a0qhyvckjexc848rkp3dgtfg82 1000stake  --keyring-backend=test --home=$HOME/.simd --chain-id=testing <<< y
# simd keys show -a validator --keyring-backend=test --home=$HOME/.simd
# cosmos1gyq9gpp5geh0a0qhyvckjexc848rkp3dgtfg82

# simd keys show validator  --keyring-backend=test --home=$HOME/.simd
# simd keys change-address validator cosmos1gyq9gpp5geh0a0qhyvckjexc848rkp3dgtfg82 --keyring-backend=test --home=$HOME/.simd  <<< y
# simd keys show validator  --keyring-backend=test --home=$HOME/.simd
